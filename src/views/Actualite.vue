<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <section class="relative bg-gradient-to-r from-[#009E60] to-[#006640] py-16 lg:py-24">
        ...
        <div class="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <button
              ...
              :class="
                selectedCategorie === 'tous'
                  ...
                  : 'bg-gray-100 text-gray-700 hover:bg-[#FCD116] hover:text-[#009E60]'
              "
            >
              Toutes
            </button>
          ...
          <div class="relative w-full lg:w-96">
            <input
              ...
              class="w-full px-4 py-2 pl-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#009E60] focus:border-transparent"
            />
    ...
    <section class="py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div class="p-8 lg:p-12 flex flex-col justify-center">
                <div class="flex items-center gap-3 mb-4">
                  ...
                  <span
                    ...
                    :class="getCategorieColor(actualiteUne.categorie)"
                  >
                ...
                <h2 class="text-3xl lg:text-4xl font-bold text-[#009E60] mb-4">
                  {{ actualiteUne.titre }}
                </h2>

                <p class="text-gray-600 text-lg mb-6">
                  {{ actualiteUne.description }}
                </p>
                ...
                <div class="flex items-center justify-between">
                  ...
                  <router-link
                    ...
                    class="inline-flex items-center gap-2 bg-[#FCD116] text-[#009E60] px-6 py-3 rounded-lg font-semibold hover:bg-[#009E60] hover:text-white transition-all group"
                  >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="relative h-56 overflow-hidden">
              ...
              <div class="absolute top-4 left-4 flex gap-2">
                <span
                  ...
                  :class="getCategorieColor(actualite.categorie)"
                >
              ...
              <div class="absolute top-4 right-4">
                <button
                  @click="toggleLike(actualite.id)"
                  class="bg-white/90 hover:bg-white p-2 rounded-full transition-all"
                >
                  <i
                    class="bx bx-heart text-red-500"
                    :class="{ 'bxs-heart': actualite.liked }"
                  ></i>
                </button>
              </div>
            ...
            <div class="p-6">
              ...
              <h3
                class="font-bold text-xl mb-3 text-[#009E60] hover:text-[#3A75C4] transition-colors"
              >
                <router-link :to="`/actualites/${actualite.id}`">
                  {{ actualite.titre }}
                </router-link>
              </h3>
              ...
              <div class="flex items-center justify-between">
                ...
                <router-link
                  ...
                  class="text-[#3A75C4] font-semibold inline-flex items-center gap-1 hover:gap-2 transition-all group"
                >
                  Lire la suite
                ...
                <div class="flex items-center gap-3 text-sm text-gray-500">
                  ...
                  >
                    <i
                      class="bx bx-heart"
                      :class="{
                        'bxs-heart text-red-500': actualite.liked
                      }"
                    ></i>
                  ...
                  <button
                    class="flex items-center gap-1 hover:text-[#009E60] transition-colors"
                  >
        ...
        <div
          v-if="actualitesFiltrees.length === 0"
        ...
        <div class="mt-12 flex justify-center">
          <nav class="flex items-center gap-2">
            ...
            <button
              ...
              class="w-10 h-10 rounded-lg border border-gray-300 flex items-center justify-center hover:bg-[#FCD116] hover:text-[#009E60] transition-colors disabled:opacity-50 disabled:hover:bg-transparent"
            >
            ...
            <button
              ...
              :class="
                pageCourante === page
                  ? 'bg-[#009E60] text-white'
                  : 'border border-gray-300 hover:bg-[#FCD116] hover:text-[#009E60]'
              "
            >
              {{ page }}
            </button>
    ...
    <!-- Section newsletter -->
    <section
      class="py-20 bg-gradient-to-r from-[#009E60] to-[#006640]"
    >
      <div
      ...
      >
        ...
        <p
          class="text-xl text-white/90 mb-8 max-w-2xl mx-auto"
        >
        ...
        >
          ...
          <button
            type="submit"
            class="bg-[#FCD116] text-[#009E60] px-8 py-4 rounded-lg font-semibold hover:bg-white transition-all whitespace-nowrap flex items-center justify-center gap-2"
          >
            S'abonner
        ...
        <p class="text-white/70 text-sm mt-4">
          En vous abonnant, vous acceptez de recevoir nos actualités.
...
import hero4Image from '@/assets/images/hero4.jpg'
...
const toutesActualites = ref([
...

  {
    id: 2,
    titre:
      "Célébration de la Journée Internationale de la Femme à l'Ambassade",
    description:
      "Une cérémonie spéciale a été organisée pour honorer les femmes gabonaises et leur contribution au développement de notre pays.",
    image: hero3Image,
    date: '2024-03-10',
    categorie: 'ambassade',
    tempsLecture: 2,
...

  {
    id: 5,
    titre:
      "Communiqué sur les nouvelles procédures de visa",
    description:
      "L'Ambassade informe ses ressortissants des changements concernant les procédures de demande de visa à compter du 1er avril 2024.",
    image: hero4Image,
    date: '2024-02-25',
...

  {
    id: 9,
    titre:
      "Célébration de l'indépendance du Gabon",
    description:
      "La communauté gabonaise s'est rassemblée pour célébrer le 66ème anniversaire de l'indépendance de notre pays.",
    image: hero4Image,
    date: '2024-02-05',
    categorie: 'evenement',
    tempsLecture: 3,
...
const actualiteUne = computed(() => {
  return toutesActualites.value[0]
})
...
const actualitesFiltrees = computed(() => {
  ...
  if (selectedCategorie.value !== 'tous') {
    filtered = filtered.filter(
      actualite => actualite.categorie === selectedCategorie.value
    )
  }
  ...
  if (searchQuery.value) {
    ...
    filtered = filtered.filter(
      actualite =>
        actualite.titre.toLowerCase().includes(query) ||
        actualite.description.toLowerCase().includes(query)
    )
  }

  // Pagination
  const debut =
    (pageCourante.value - 1) * articlesParPage
...
const pagesTotales = computed(() => {
  ...
  return Math.ceil(
    filtered.length / articlesParPage
  )
})
...
// ============================================================
// LIKE D'UNE ACTUALITÉ
// ============================================================

const toggleLike = (id) => {
  const actualite =
    toutesActualites.value.find(
  ...
  if (actualite) {
    ...
    actualite.likes += actualite.liked
      ? 1
      : -1
  }
}
...
const subscribeNewsletter = () => {
  alert(
    `Merci pour votre abonnement avec l'adresse : ${email.value}`
  )
