<template>
  <aside
    :class="[
      'fixed left-0 top-0 h-full bg-gradient-to-b from-[#009E60] to-[#006640] text-white shadow-xl flex flex-col transition-all duration-300 z-[1000]',
  ...
  >
    ...
    <button
      @click="toggleSidebar"
      class="absolute -right-3 top-20 bg-[#FCD116] text-[#009E60] rounded-full p-1 cursor-pointer shadow-lg transition-all duration-300 hover:scale-110 z-10"
    >
    ...
    <nav class="flex-1 flex flex-col gap-1 px-3 overflow-y-auto">
      ...
      <div>
        <div
          @click="toggleAdmin"
          class="flex items-center justify-between px-4 py-3 rounded-xl cursor-pointer transition-all duration-300 text-white hover:bg-[#FCD116]/20 hover:text-[#FCD116]"
        >
        ...
        <div v-show="isAdminOpen" class="ml-2 flex flex-col gap-1">
          <router-link
            to="/dashboard"
            class="flex items-center gap-3 px-4 py-2 rounded-xl text-white no-underline transition-all duration-300 text-sm font-medium hover:bg-[#FCD116]/20 hover:text-[#FCD116] hover:translate-x-1"
            active-class="!bg-[#FCD116] !text-[#009E60]"
          >
...
import logo1 from '@/assets/images/Gabonarmoirie.png'
