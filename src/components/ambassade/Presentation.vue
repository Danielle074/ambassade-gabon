<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="relative h-[500px] bg-cover bg-center" :style="{ backgroundImage: 'url(https://images.unsplash.com/photo-1574457545171-cb9a5e4f3b7a?w=1400)' }">
      <!-- Dégradé avec couleurs Gabon -->
      <div class="absolute inset-0 bg-gradient-to-r from-[#3A75C4]/90 to-[#009E60]/80"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
      ...
      <div class="bg-white rounded-2xl shadow-xl p-8 mb-12 -mt-20 relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div class="flex items-start gap-4">
            <div class="bg-[#009E60] p-4 rounded-full">
              <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
        ...
        <div class="bg-gradient-to-br from-[#009E60] to-[#006640] text-white rounded-2xl p-6 shadow-xl">
      ...
      <div class="mb-16">
        <h2 class="text-3xl font-bold text-gray-800 mb-6 flex items-center">
          <span class="bg-[#009E60] w-1 h-8 mr-3"></span>
          Notre Mission
        </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow border-t-4 border-[#3A75C4]">
            <div class="bg-[#3A75C4]/10 w-16 h-16 rounded-full flex items-center justify-center mb-4">
          ...
          <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow border-t-4 border-[#009E60]">
            <div class="bg-[#009E60]/10 w-16 h-16 rounded-full flex items-center justify-center mb-4">
            ...
            <p class="text-gray-600">Sur instructions du Gouvernement Gabonais, elle négocie les traités et accords bilatéraux.</p>
          </div>
          ...
          <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow border-t-4 border-[#3A75C4]">
            ...
            <p class="text-gray-600">Elle protège les ressortissants Gabonais établis dans sa juridiction, en étroite collaboration avec le Consulat.</p>
          </div>
        </div>
      ...
      <!-- Chiffres clés -->
      <div class="bg-gradient-to-r from-[#3A75C4] to-[#009E60] text-white rounded-2xl p-8 mb-16">
        <h3 class="text-2xl font-bold text-center mb-8">L'Ambassade en chiffres</h3>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
            <div class="text-4xl font-bold mb-2">1960</div>
    ...
    <div class="bg-gray-900 text-white py-16 mt-16">
      <div class="max-w-7xl mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <router-link to="/contact" class="bg-[#3A75C4] text-white px-8 py-3 rounded-full font-semibold hover:bg-[#2a5a9e] transition-colors inline-flex items-center gap-2">
...
.bg-gradient-hero {
  background: linear-gradient(135deg, #3A75C4 0%, #2a5a9e 50%, #009E60 100%);
}
