  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
      ...
      <div class="bg-white rounded-2xl shadow-xl p-8 mb-12">
        ...
        <div class="bg-gradient-to-r from-[#3A75C4] to-[#2a5a9e] text-white rounded-xl p-6 mb-8">
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <h3 class="text-2xl font-bold">Madame [Nom de l'Attachée]</h3>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div class="bg-gray-50 rounded-xl p-6">
            <h3 class="text-xl font-bold text-gray-800 mb-4 flex items-center">
              <svg class="w-5 h-5 text-[#3A75C4] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
            ...
            <a href="#" target="_blank" class="inline-flex items-center gap-2 bg-[#3A75C4] text-white px-4 py-2 rounded-lg mt-4 hover:bg-[#2a5a9e] transition-colors">
              Portail officiel des visas
          ...
          <div class="bg-orange-50 border border-orange-200 rounded-xl p-6">
            ...
            <a href="#" target="_blank" class="inline-flex items-center gap-2 bg-[#009E60] text-white px-4 py-2 rounded-lg mt-4 hover:bg-[#006640] transition-colors">
      ...
      <div class="bg-white rounded-2xl shadow-xl p-8">
        ...
        <div class="mt-8 bg-[#3A75C4]/5 border border-[#3A75C4]/20 rounded-xl p-6">
