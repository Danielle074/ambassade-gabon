    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <form @submit.prevent="submitRendezVous" class="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#3A75C4] focus:border-transparent"
                  required
                >
              ...
              <div class="flex justify-center pt-4">
                <button
                  ...
                  class="bg-[#3A75C4] text-white px-10 py-4 rounded-lg font-semibold hover:bg-[#2a5a9e] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-3 text-lg shadow-lg hover:shadow-xl"
                >
        ...
        <div class="space-y-6">
          ...
          <div class="bg-white rounded-2xl shadow-xl p-6">
            ...
            <div class="space-y-2">
              ...
              <div class="flex justify-between py-2">
                ...
                <span class="font-semibold text-[#3A75C4]">Fermé</span>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-2xl shadow-xl p-6">
            ...
            <div class="space-y-3">
              <div class="flex items-start gap-3">
                <svg class="w-5 h-5 text-[#3A75C4] mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Documents requis -->
          <div class="bg-gradient-to-r from-[#3A75C4] to-[#009E60] text-white rounded-2xl p-6">
      ...
      <div v-if="showModal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
        <div class="bg-white rounded-2xl max-w-md w-full p-8 text-center">
          ...
          <button
            @click="closeModal"
            class="bg-[#3A75C4] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#2a5a9e] transition-colors"
          >
            Fermer
          </button>
        </div>
