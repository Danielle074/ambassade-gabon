<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-[#3A75C4] text-white py-16 px-4">
      ...
      <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
        ...
        <div class="relative w-full md:w-64">
          <input
            ...
            class="w-full px-4 py-2 pl-10 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#3A75C4] focus:border-transparent"
          >
        </div>
      </div>
...
const actualites = ref([
  {
    titre: "Cérémonie de commémoration de l'indépendance du Gabon",
